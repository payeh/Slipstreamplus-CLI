...
### 🌐 About Slipstream
Slipstream uses the DNS protocol to help you bypass strict restrictions and 2026-era whitelisting systems. 🔓🛰️
...
3. Performs real latency tests (RealPing) on working IPs ⏱️
...
- Flexible output options (scan OK / realtest OK) 🗂️
...
- `0` -> scan all IPs in the CIDR (can be very heavy) ⚠️
...
- When `--ui` is enabled, text output is disabled by default ⚙️
...
- Large CIDRs without random selection can be very heavy ⚠️
